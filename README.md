...
- `/events` — create/edit/publish/unpublish/cancel; `/events/:id` — tabs for **Registrations** (external + own, separated; delete; replace receipt; CSV export) and **Attendance** (same UI as meetings)
